...
public class  ShopFragment extends Fragment implements ShopListAdapter.ShopInterface {
    ...
    public void addItem(Product product) {
        ...
        if (isAdded) {
            Snackbar.make(requireView(), product.getName() + " ditambah ke keranjang ", Snackbar.LENGTH_LONG)
            ...
            Snackbar.make(requireView(), "maximal 5 setiap produk", Snackbar.LENGTH_LONG)
                    .show();
        }
    }
